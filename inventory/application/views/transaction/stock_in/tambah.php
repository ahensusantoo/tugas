	...
	<div class="box">
		<div class="box-header">
			...
			<div class="pull-right btn-flat">
				<a href="<?php echo site_url('stock/in') ?>" class="btn btn-warning">
					...
					<form action="<?=site_url('stock/process')?>" method="post">
						...
						<div class="form-group">
							...
							<select name="supplier" class="form-control">
								...
								<?php foreach ($supplier as $key => $supplier) { ?>
						...
						<div class="form-group">
							<button type="submit" name="in_add" class="btn btn-success  btn-flat"><i class="fa fa-paper-plane">Save</i></button>
